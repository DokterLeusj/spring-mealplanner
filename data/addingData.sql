...
VALUES (1, 'Classic Italian pasta dish with savory Bolognese sauce.', 'https://i.imgur.com/D2k7lJE.jpg',
       ...
       (21,
        'Vegan Lentil Curry: Tender lentils in coconut milk and tomato sauce with aromatic spices, delivering a satisfying, plant-based experience.',
        null, 'Vegan Lentil Curry', true, 17),
       (22,
        'Grilled Chicken Caesar Salad: Juicy grilled chicken on crisp romaine lettuce with croutons, cherry tomatoes, and Parmesan, drizzled with creamy Caesar dressing.',
        null, 'Grilled Chicken Caesar Salad', false, 8),
       (23,
        'Roasted Vegetable Quinoa Bowl: Colorful roasted bell peppers, zucchini, and cherry tomatoes with fluffy quinoa, drizzled with balsamic glaze and fresh basil.',
        null, 'Roasted Vegetable Quinoa Bowl', true, 23),
       (24,
        'Spicy Shrimp Stir-Fry: Succulent shrimp with vibrant vegetables in a fiery garlic sauce, served over steamed rice or noodles for a tantalizing fusion of heat and savor.',
        null, 'Spicy Shrimp Stir-Fry', false, 11),
       (25,
        'Mushroom Risotto: Rich and creamy Arborio rice with sautéed mushrooms, garnished with Parmesan cheese and fresh parsley for a luxurious and comforting dining experience.',
        null, 'Mushroom Risotto', true, 13),
       (26,
        'Black Bean and Corn Salad: Hearty combination of black beans and sweet corn with juicy tomatoes and crisp red onions, drizzled with zesty dressing for a refreshing and nutritious salad.',
        null, 'Black Bean and Corn Salad', false, 6),
       (27,
        'Honey Mustard Glazed Salmon: Perfectly grilled salmon glazed with a luscious blend of honey and mustard, served alongside vibrant vegetables for a perfect harmony of sweet and savory.',
        null, 'Honey Mustard Glazed Salmon', true, 28),
       (28,
        'Caprese Pasta Salad: Al dente pasta with cherry tomatoes, mozzarella, and fresh basil, drizzled with balsamic glaze and olive oil for a refreshing and satisfying ode to the classic Caprese.',
        null, 'Caprese Pasta Salad', false, 15),
       (29,
        'Chickpea and Spinach Stew: Flavorful stew with sautéed onions, garlic, carrots, tender chickpeas, diced tomatoes, and fresh spinach for a hearty and wholesome experience.',
        null, 'Chickpea and Spinach Stew', true, 5),
       (30,
        'Teriyaki Tofu Stir-Fry: Cubes of tofu in a sweet and tangy teriyaki sauce with crisp vegetables, served over steamed rice or noodles for a symphony of Asian-inspired flavors.',
        null, 'Teriyaki Tofu Stir-Fry', false, 20),
       (31,
        'Pesto Chicken Penne: Juicy chicken slices, cherry tomatoes, and al dente penne pasta in a velvety pesto sauce, garnished with grated Parmesan for a celebration of fresh, herbaceous flavors.',
        null, 'Pesto Chicken Penne', true, 1),
       (32,
        'Cauliflower and Chickpea Curry: Diced onions, garlic, and ginger sautéed to perfection with cauliflower florets and chickpeas in a fragrant stew, served over basmati rice or quinoa.',
        null, 'Cauliflower and Chickpea Curry', false, 9),
       (33,
        'Mango Avocado Salsa: Ripe mangoes and avocados with red onions, jalapeños, and Coriander in a tantalizing salsa, enhanced with a splash of lime juice for a delightful treat.',
        null, 'Mango Avocado Salsa', true, 12),
       (34,
        'Lemon Garlic Shrimp Pasta: Succulent shrimp sautéed in garlic-infused olive oil with cherry tomatoes and baby spinach, combined with lemon juice and fresh herbs for a comforting and invigorating pasta.',
        null, 'Lemon Garlic Shrimp Pasta', false, 29),
       (35,
        'Stuffed Bell Peppers: Ground turkey, cooked quinoa, black beans, and corn in a flavorful mixture, creating a hearty filling for vibrant bell peppers, baked to perfection with melted cheese.',
        null, 'Stuffed Bell Peppers', true, 18),
       (36,
        'Mediterranean Quinoa Salad: Quinoa with cherry tomatoes, olives, cucumbers, and feta cheese, drizzled with olive oil and oregano for a celebration of Mediterranean flavors.',
        null, 'Mediterranean Quinoa Salad', false, 14),
       (37,
        'Vegetarian Pad Thai: Rice noodles stir-fried with tofu, bean sprouts, and julienned carrots in a delectable tamarind-infused sauce, garnished with crushed peanuts and lime wedges.',
        null, 'Vegetarian Pad Thai', true, 26),
       (38,
        'Lentil and Vegetable Stew: Sautéed onions, carrots, and celery with tender lentils, diced tomatoes, and a fragrant blend of herbs for a hearty and wholesome stew.',
        null, 'Lentil and Vegetable Stew', false, 3),
       (39,
        'Cajun Shrimp and Sausage Skillet: Sliced sausage, succulent shrimp, and vibrant vegetables in a fiery and flavorful concoction, served over rice for a spicy and satisfying experience.',
        null, 'Cajun Shrimp and Sausage Skillet', true, 25),
       (40,
        'Butternut Squash Risotto: Arborio rice in a velvety blend of sautéed onions, butter, and roasted butternut squash, garnished with sage and Parmesan cheese for a creamy and comforting autumnal celebration.',
...
-- Roasted Vegetable Quinoa Bowl
       ...
       (106, 0.03, 88, 4),  -- Sriracha (Qty: 0.03 l)
...
-- Caprese Pasta Salad
       ...
       (132, 20, 57, 2),    -- Fresh basil (Qty: 20 grams)
...
-- Pesto Chicken Penne
       ...
       (157, 300, 36, 2),   -- Penne pasta (Qty: 300 grams)
       (158, 250, 63, 2),   -- Cherry tomatoes (Qty: 250 grams)
       (159, 0.1, 44, 4),   -- Pesto sauce (Qty: 0.1 l)
...
-- Cauliflower and Chickpea Curry
       (164, 1, 79, 4),     -- Cauliflower (Qty: 1 piece)
       ...
       (169, 1, 43, 2),     -- Tomato (Qty: 1 piece)
       (170, 0.4, 75, 4),   -- Coconut milk (Qty: 0.4 l)
       (171, 2, 60, 2),     -- Curry powder (Qty: 2 tbs)
       (172, 1, 28, 2),     -- Turmeric (Qty: 1 tbs)
       (173, 1, 26, 2),     -- Cumin (Qty: 1 tbs)
       (174, 1, 17, 2),     -- Coriander (Qty: 1 tbs)

-- Mango Avocado Salsa
       (175, 2, 56, 2),     -- Mango (Qty: 2 pieces)
       (176, 2, 89, 2),     -- Avocado (Qty: 2 pieces)
       (177, 1, 13, 2),     -- Red onion (Qty: 1 piece)
       (178, 1, 63, 2),     -- Jalapeño (Qty: 1 piece)
       (179, 30, 91, 5),    -- Coriander (Qty: 30 grams)
       (180, 2, 29, 6),     -- Lime juice (Qty: 2 tbs)
...
-- Lemon Garlic Shrimp Pasta
       ...
       (186, 150, 92, 2),   -- Spinach (Qty: 150 grams)
       (187, 4, 7, 3),      -- Garlic (Qty: 4 cloves)
       (188, 2, 29, 6),     -- Lemon juice (Qty: 2 tbs)
...
-- Stuffed Bell Peppers
       ...
       (193, 150, 49, 2),   -- Quinoa (Qty: 150 grams)
...
-- Mediterranean Quinoa Salad
       ...
       (207, 2, 29, 6),     -- Lemon juice (Qty: 2 tbs)
